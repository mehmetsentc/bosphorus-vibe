                  ...
                  child: Stack(
                    children: [
                      if (!functions.hasUploadedMedia(
                          _model.uploadedFileUrl_uploadDataKp0))
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataTf7 = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataTf7 = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataTf7 =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDataTf7 =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                          ...
                          child: Container(
                            ...
                            child: Visibility(
                              visible: functions.hasUploadedMedia(
                                  _model.uploadedFileUrl_uploadDataDcr),
                              child: Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: FlutterFlowMediaDisplay(
                                  path: _model.uploadedFileUrl_uploadDataDcr,
                      ...
                      if ((_model.isDataUploading_uploadDataTf7 == true) ||
                          (_model.isDataUploading_uploadDataDcr == true))
                        Align(
                          alignment: AlignmentDirectional(0.0, 0.0),
                          child: Lottie.asset(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                                ...
                                if (selectedMedia != null &&
                                    selectedMedia.every((m) =>
                                        validateFileFormat(
                                            m.storagePath, context))) {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataDcr = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadDataDcr =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataDcr =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataDcr =
                                          downloadUrls.first;
                                    });
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                  selectedMedia.every((m) => validateFileFormat(
                                      m.storagePath, context))) {
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataKp0 = true);
                                var selectedUploadedFiles = <FFUploadedFile>[];
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadDataKp0 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                        selectedMedia.length &&
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataKp0 =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataKp0 =
                                        downloadUrls.first;
                                  });
                      ...
                      if ((_model.uploadedFileUrl_uploadDataKp0 != '') ||
                          (_model.uploadedFileUrl_uploadDataDcr != ''))
                        FFButtonWidget(
                          onPressed: () async {
                            await UserStoriesRecord.collection
                                ...
                                .set(createUserStoriesRecordData(
                                  ...
                                  isOwner: true,
                                  expiredAt: functions
                                      .tomorrowDate(getCurrentTimestamp),
                                  videoUrl:
                                      _model.uploadedFileUrl_uploadDataDcr,
                                ));
