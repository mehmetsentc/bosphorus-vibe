...
import 'responsible_reels_clone_copy_model.dart';
export 'responsible_reels_clone_copy_model.dart';

class ResponsibleReelsCloneCopyWidget extends StatefulWidget {
  const ResponsibleReelsCloneCopyWidget({
    super.key,
    this.selectedIndex,
    this.postDet,
  });
  ...
  static String routeName = 'responsible_Reels_CloneCopy';
  static String routePath = '/responsibleReelsCloneCopy';

  @override
  State<ResponsibleReelsCloneCopyWidget> createState() =>
      _ResponsibleReelsCloneCopyWidgetState();
}

class _ResponsibleReelsCloneCopyWidgetState
    extends State<ResponsibleReelsCloneCopyWidget>
    with TickerProviderStateMixin {
  late ResponsibleReelsCloneCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResponsibleReelsCloneCopyModel());
