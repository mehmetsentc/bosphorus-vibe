...
import 'event_app_porty_main_page1_unregister_model.dart';
export 'event_app_porty_main_page1_unregister_model.dart';

class EventAppPortyMainPage1UnregisterWidget extends StatefulWidget {
  const EventAppPortyMainPage1UnregisterWidget({
    super.key,
    this.eventRef,
    this.userRecord,
  });
  ...
  static String routeName = 'event_App_Porty_Main_Page_1_unregister';
  static String routePath = '/eventAppPortyMainPage_1_unregister';

  @override
  State<EventAppPortyMainPage1UnregisterWidget> createState() =>
      _EventAppPortyMainPage1UnregisterWidgetState();
}

class _EventAppPortyMainPage1UnregisterWidgetState
    extends State<EventAppPortyMainPage1UnregisterWidget> {
  late EventAppPortyMainPage1UnregisterModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => EventAppPortyMainPage1UnregisterModel());
