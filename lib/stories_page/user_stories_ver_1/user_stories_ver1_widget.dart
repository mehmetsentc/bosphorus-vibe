...
import 'user_stories_ver1_model.dart';
export 'user_stories_ver1_model.dart';

class UserStoriesVer1Widget extends StatefulWidget {
  const UserStoriesVer1Widget({
    super.key,
  ...
  static String routeName = 'userStories_ver_1';
  static String routePath = '/userStoriesVer1';

  @override
  State<UserStoriesVer1Widget> createState() => _UserStoriesVer1WidgetState();
}

class _UserStoriesVer1WidgetState extends State<UserStoriesVer1Widget> {
  late UserStoriesVer1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserStoriesVer1Model());
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Visibility(
                                                            visible: reelsVideoCloneUserStoriesRecord
                                                                        .storyPhoto !=
                                                                    '',
                                                            child:
                                                                Image.network(
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (reelsVideoCloneUserStoriesRecord
                                                                              .user ==
