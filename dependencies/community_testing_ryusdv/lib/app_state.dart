...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    _safeInit(() {       if (prefs.containsKey('ff_notificationDT')) {
        try {
          final serializedData = prefs.getString('ff_notificationDT') ?? '{}';
          _notificationDT = NotificationStruct.fromSerializableMap(jsonDecode(serializedData));
        } catch (e) {
  ...
  late SharedPreferences prefs;
      ...
      NotificationStruct _notificationDT  = NotificationStruct.fromSerializableMap(jsonDecode('{\"title\":\"This is a test\",\"description\":\"This is test description\",\"style\":\"fillColored\",\"position\":\"topCenter\",\"type\":\"info\",\"progressBar\":\"true\",\"pauseOnHover\":\"false\"}'));
